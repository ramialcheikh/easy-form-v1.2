...
class FormSubmissionFile extends ActiveRecord
{
    ...
    {
        return ['id', 'name', 'originalName', 'extension', 'sizeWithUnit', 'link'];
    }
    ...
    {
        return Form::FILES_DIRECTORY . DIRECTORY_SEPARATOR . $this->form_id;
    }
    ...
    {
        return Url::to('@web' . DIRECTORY_SEPARATOR . $this->getFilePath(), false);
    }
