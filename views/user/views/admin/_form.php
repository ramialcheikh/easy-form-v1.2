        ...
        <div class="row">
            <div class="col-sm-2">
                ...
                <div class="form-group">
                    ...
                    <?php // Html::activeCheckbox($user, 'ban_time', ['label' => Yii::t('app', 'Banned') ]); ?>
            ...
            <div class="col-sm-10" id="banReason" style="display: none">
                <?= $form->field($user, 'ban_reason')
                    ->textInput(['placeholder' => Yii::t('app', 'When the user tries to log in,
...
$( document ).ready(function() {
    ...
    $('#user-ban_time').on('init.bootstrapSwitch', function(event, state) {
        if( this.checked ) {
            $('#banReason').show();
        } else {
            $('#banReason').hide();
