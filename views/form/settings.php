                        ...
                        'rows' => [
                            ...
                            [
                                'attributes' => [
                                    'mail_message' => [
                                        'type'=>Form::INPUT_TEXTAREA,
                                        'hint'=> Yii::t("app", "Allowed HTML Tags:") . ' ' . Html::encode(
                                ...
                                'attributes' => [
                                    'type' => [
                                        ...
                                        'value'=>$form->field($formEmailModel, 'type')->radioButtonGroup(
                                            ...
                                            "app",
                                            "This email may contain all submitted data,
                                            a link to saved data or a custom message."
                                        )),
                                    ],
                                    'attach' => [
                            ...
                            [
                                'attributes' => [
                                    'message' => ['type'=>Form::INPUT_TEXTAREA, 'hint'=>
                                        Yii::t("app", "Allowed HTML Tags:") . ' ' .
                                        Html::encode('<a> <em> <strong> <cite> <code> <ul> <ol> <li> <dl> <dt> <dd>'),
                                        'options'=>['placeholder'=> Yii::t("app", "Enter your custom message...")]],
                                ],
                            ],
                        ]
                    ]);
