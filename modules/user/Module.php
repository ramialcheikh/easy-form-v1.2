...
class Module extends \yii\base\Module
{
    ...
    protected function checkModuleProperties()
    {
        ...
        if (!Yii::$app->request->isConsoleRequest &&
            !Yii::$app->get("user") instanceof \app\modules\user\components\User) {
            throw new InvalidConfigException(
                'Yii::$app->user is not set properly. It needs to extend \app\modules\user\components\User'
            );
        }
    }
    ...
    protected function getDefaultModelClasses()
    {
        return [
			...
			'RegisterForm'  => 'app\modules\user\models\forms\RegisterForm',
